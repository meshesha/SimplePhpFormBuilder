<?php
    ...
    // *** default template: default, x-white,spfb
    define('EI_TEMPLATE', 'spfb');
    ...
    define('EI_CONFIG_FILE_DIRECTORY', '../settings/');
    ...
    // -------------------------------------------------------------------------
    // *** application name
    define('EI_APPLICATION_NAME', 'SimplePhpFormBuilder');
    ...
    define('EI_POST_INSTALLATION_TEXT', 'Congratulations,<br> the app was successfully installed.<br> The administrator account is:<br>
    Username: "admin".
    Password: "Admin123".
    <br>
    We recommend that you change your password after initial login.');
