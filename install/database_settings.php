...
<div id="main">
	...
	<div id="content">
		...
		<div class="central-part">
			...
			<!-- simplePhpFormBuilder v1.0.0 not allowed custom  database_name  -->
			<?php $database_name="formbuilder"; ?>
			<tr>
				<td nowrap>&nbsp;<?php echo lang_key('database_name'); ?>: <span class="star">*</span></td>
				<td>
					<input type="text" style="background-color: #dddddd;" class="form_text" name="database_name" id="database_name" size="30" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> value="<?php echo $database_name; ?>" placeholder="<?php if(EI_MODE == 'demo') echo 'demo: db_name'; ?>" onfocus="textboxOnFocus('notes_db_name')" onblur="textboxOnBlur('notes_db_name')" readonly/>					
				</td>
			</tr>
			<tr>
			...
			<!-- simplePhpFormBuilder v1.0.0 not allowed database_prefix  -->
