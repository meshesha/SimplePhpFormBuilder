...
jQuery.fn.dataTable.Api.register('MakeCellsEditable()', function (settings) {
    ...
    jQuery.fn.extend({
        ...
        updateEditableCell: function (callingElement) {
            ...
            if (!newValue && ((settings.allowNulls) && settings.allowNulls != true)) {
                ...
                if (settings.allowNulls.columns) {
                    ...
                    if (settings.allowNulls.columns.indexOf(columnIndex) > -1) {
                        _update(newValue,callingElement);
                    } else {
                        _addValidationCss();
                    }
            ...
            function _update(newValue,callingElement) {
                var oldValue = cell.data();
                cell.data(newValue);
                var tblId = table.table().node().id;
                //Return cell & row.
                settings.onUpdate(cell, row, oldValue, tblId, columnIndex);
            }
            // Get current page
    ...
    if (table != null) {
        ...
        $(table.body()).on('click', 'td', function () {
            ...
            if(table.data().length !==0){ /**Amir: prevent error when the table is empty (no rows) */
                var currentColumnIndex = table.cell(this).index().column;
                var checkBox = $("#" + settings.checkBoxId);
                // DETERMINE WHAT COLUMNS CAN BE EDITED
                if ((settings.checkBoxId && checkBox.is(":checked") || !settings.checkBoxId) && ((settings.columns && settings.columns.indexOf(currentColumnIndex) > -1) || (!settings.columns && !settings.exceptColumns) || (!settings.columns && settings.exceptColumns && settings.exceptColumns.indexOf(currentColumnIndex) == -1))) {
...
function getInputHtml(currentColumnIndex, settings, oldValue) {
    ...
    if (settings.confirmationButton) {
        ...
        confirmText = settings.confirmationButton.confirmText || "";
        cancelText = settings.confirmationButton.cancelText || "";
    ...
    switch (inputType) {
        ...
        case "list-confirm": // List w/ confirm
            ...
            input.html = input.html + "</select>&nbsp;<a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this);'>" + confirmText +"</a> <a href='javascript:void(0);' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>" + cancelText + "</a> ";
            input.focus = false;
            break;
        ...
        case "datepicker-confirm":
	        ...
	        input.html = "<input id='ejbeatycelledit' type='text' name='date' class='datepick " + inputCss + "'   value='" + oldValue + "'></input> &nbsp;<a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>" + confirmText +"</a> <a href='javascript:void(0);' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>" + cancelText + "</a>";
        ...
        case "text-confirm": // text input w/ confirm
            input.html = "<input id='ejbeatycelledit' class='" + inputCss + "' value='"+oldValue+"'></input>&nbsp;<a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>" + confirmText +"</a> <a href='javascript:void(0);' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>" + cancelText + "</a> ";
            break;
        ...
        case "textarea-confirm":
            input.html = "<textarea id='ejbeatycelledit' class='" + inputCss + "'>"+oldValue+"</textarea><a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>" + confirmText +"</a> <a href='javascript:void(0);' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>" + cancelText + "</a>";
            break;
        default: // text input
